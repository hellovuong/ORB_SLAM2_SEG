...
int main(int argc, char **argv)
{
    ...
    int nDImages = vstrImageFilenamesD.size(); 
                ...
                vector<string> &vstrImageFilenamesD, vector<double> &vTimestamps)
{
    ...
    string strtoColor = strAssociationFilename + "/color.txt";
    fAssociation.open(strtoColor.c_str());
    ...
    fAssociation.close();
    string strtoDepth = strAssociationFilename + "/aligned_depth.txt";
    fAssociation.open(strtoDepth.c_str());
    while(!fAssociation.eof())
    {
        string s;
        getline(fAssociation,s);
